...
export const productList = [
  ...
  { label: 'Phos-Force™', nutrientContent: { Nitrogen: 4.2, Calcium: 4.3, Phosphorus: 14.3, Iron: 3.5 }, description: 'An advanced phosphate fertiliser delivering phosphate, calcium, and iron in a plant-available liquid. Formulated to increase brix, plant health, and nutrient availability.' },
  ...
  { label: 'NTS Fast Fulvic™', nutrientContent: {}, description: 'An 8 % fulvic acid liquid possessing a myriad of yield-enhancing qualities. Fulvic Acid is a powerful organic extract from humates which offers a host of benefits for both the soil and the plant.' },
