...
export const productList = [
  ...
  { label: 'Urea', nutrientContent: { Nitrogen: 46 }, description: 'A highly concentrated nitrogen fertilizer that promotes vigorous vegetative growth and rapid green-up in crops.' },
  ...
  { label: 'NTS Fast Fulvic™', nutrientContent: { Nitrate: 0.1, Ammonium: 0.1, Calcium: 0.1, Magnesium: 0.1, Potassium: 0.1, Phosphorus: 0.1, Sulphur: 0.1 }, phLogic: { min_pH: 4, max_pH: 12 }, releaseType: 'fast',description: 'An 8 % fulvic acid liquid possessing a myriad of yield-enhancing qualities. Fulvic Acid is a powerful organic extract from humates which offers a host of benefits for both the soil and the plant.' },
  { label: 'NTS Fulvic Acid Powder™', nutrientContent: { Nitrate: 0.1, Ammonium: 0.1, Calcium: 0.1, Magnesium: 0.1, Potassium: 0.1, Phosphorus: 0.1, Sulphur: 0.1 }, phLogic: { min_pH: 4, max_pH: 12 }, releaseType: 'fast' ,description: 'Fulvic acid in a concentrated, soluble powder – the most versatile and productive input in agriculture, in freight-friendly form. Fulvic acid is a powerful organic extract from humates which offers a host of benefits for both the soil and the plant.'},
  ...
  { label: 'NTS Stabilised Boron Granules™', nutrientContent: { Nitrate: 0.1, Ammonium: 0.1, Calcium: 0.1, Magnesium: 0.1, Potassium: 0.1, Phosphorus: 0.1, Sulphur: 0.1 }, phLogic: { min_pH: 4, max_pH: 12 }, releaseType: 'fast' ,description: 'A slow-release boron source bound with humates to reduce leaching and extend availability, supporting flowering, fruit set, and calcium mobility.'},
  ...
  { label: 'Soluble Boron™', nutrientContent: { Boron: 15 }, phLogic: { min_pH: 5.0, max_pH: 8.0 }, releaseType: 'fast' },
  { label: 'Boric Acid™', nutrientContent: { Boron: 17 }, phLogic: { min_pH: 5.5, max_pH: 8.5 }, releaseType: 'moderate' },
  { label: 'Biomin Calcium™', nutrientContent: { Calcium: 15, Nitrogen: 3.6 }, phLogic: { min_pH: 4.0, max_pH: 8.0 }, releaseType: 'fast' },  // Add more as needed
];
